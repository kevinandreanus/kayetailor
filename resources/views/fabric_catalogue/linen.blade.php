...
@section('content')
    <div id="desktopviewz">
        <div class="bannertopz">
            <img src="{{ asset('images/fabric_catalogue/linen2.PNG') }}" alt="" width="100%" style="height: 650px;">
            <div class="centered">
        ...
        <div class="text-center mt-5 mb-4" style="margin-top: 100px !important;">
            <h3 style="color: white !important;" class="titlecus">LINEN</h3>
        </div>
        <div class="container">
            <div class="aboutusdynamic pt-3 pb-5">
                <p style="line-height: 200%; text-align: center !important;" class="mt-4">Linen is popular for
                    summertime fabric, because linen
                    breathes
                    very easily. It' really suitable for Indonesia's tropical weather
                </p>
            </div>
        </div>
    ...
    <div class="container" id="mobileviewz">
        <div class="text-center" style="margin-top: 100px">
            ...
            <h3 class="mt-5"
                style="color: white;font-family: 'EB Garamond', serif;font-weight:700;letter-spacing:2px;">LINEN</h3>
            <img class="mt-2" style="width: 100%" src="{{ asset('images/fabric_catalogue/linen2.PNG') }}"
                alt="">

            <p style="text-align: justify" class="mt-5">Linen is popular for summertime fabric, because linen
                breathes
