...
@section('content')
    <div id="desktopviewz">
        <div class="bannertopz">
            <img src="{{ asset('images/services/cheongsam.png') }}" alt="" width="100%" style="height: 650px;">
            <div class="centered">
        ...
        <div class="text-center mt-5 mb-4" style="margin-top: 100px !important;">
            <h3 style="color: #806e4f !important;" class="titlecus">CHEONGSAM</h3>
        </div>
        <div class="container">
    ...
    <div class="container" id="mobileviewz">
        <div class="text-center" style="margin-top: 100px">
            ...
            <p class="center-justified">We prodivde Sateen Cheongsam for chinese tradition of Sangjit
                ceremony</p>
