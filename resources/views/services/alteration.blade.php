...
@section('content')
    <div id="desktopviewz">
        <div class="bannertopz">
            <img src="{{ asset('images/services/alteration.png') }}" alt="" width="100%">
            <div class="centered">
        ...
        <div class="container">
            <div class="aboutusdynamic pt-3 pb-5">
                <p style="line-height: 200%;" class="mt-4">We believe every fabric from Kaye Brother's Tailor
                    deserve more wearing time,
                    whether
                    you are getting bigger or slimmer, we can help re-adjust the size just for you
                </p>
            </div>
        </div>
    ...
    <div class="container" id="mobileviewz">
        <div class="text-center" style="margin-top: 100px">
            ...
            <p class="center-justified">We believe every fabric from Kaye Brother's Tailor deserve more wearing time,
                whether
