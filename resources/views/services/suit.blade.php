...
@section('content')
    <div id="desktopviewz">
        <div class="bannertopz">
            <img src="{{ asset('images/services/pic2.png') }}" alt="" width="100%" style="height: 650px;">
            <div class="centered">
        ...
        <div class="text-center mt-5 mb-4" style="margin-top: 100px !important;">
            <h3 style="color: #806e4f !important;" class="titlecus">SUIT</h3>
        </div>
        <div class="container">
            <div class="aboutusdynamic pt-3 pb-5">
                <p style="line-height: 200%;" class="mt-4">For wedding or business occasion, we make modern and
                    classic fit suit.
                    Shirt: Inner for Fullset suit that made from cotton. Tailored & customized for you as well
                </p>
            </div>
        </div>
